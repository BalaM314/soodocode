...
export declare const programASTBranchNodeTypes: readonly ["if", "for", "for.step", "while", "do_while", "function", "procedure", "switch", "type", "class", "class.inherits", "class_function", "class_procedure"];
