import { Token, tokenTextMapping } from "../lexer/index.js";
import { ArrayVariableType, IntegerRangeVariableType, PrimitiveVariableType } from "../runtime/runtime-types.js";
import { CaseBranchRangeStatement, CaseBranchStatement, Statement, statements } from "../statements/index.js";
import { biasedLevenshtein, crash, errorBoundary, f, fail, fakeObject, forceType, impossible, isKey, max, quote, RangeArray, tryRun } from "../utils/funcs.js";
