...
export declare const statements: {
    ...
    byType: Record<"function" | "type" | "input" | "output" | "if" | "for" | "for.step" | "while" | "dowhile" | "procedure" | "switch" | "class" | "class_function" | "class_procedure" | "declare" | "define" | "constant" | "assignment" | "return" | "call" | "type.pointer" | "type.enum" | "type.set" | "type.end" | "if.end" | "else" | "switch.end" | "case" | "case.range" | "for.end" | "while.end" | "dowhile.end" | "function.end" | "procedure.end" | "openfile" | "readfile" | "writefile" | "closefile" | "seek" | "getrecord" | "putrecord" | "class.inherits" | "class.end" | "class_property" | "class_procedure.end" | "class_function.end", typeof Statement>;
...
export declare class ClassStatement extends Statement {
    static allowOnly: Set<"function" | "type" | "input" | "output" | "if" | "for" | "for.step" | "while" | "dowhile" | "procedure" | "switch" | "class" | "class_function" | "class_procedure" | "declare" | "define" | "constant" | "assignment" | "return" | "call" | "type.pointer" | "type.enum" | "type.set" | "type.end" | "if.end" | "else" | "switch.end" | "case" | "case.range" | "for.end" | "while.end" | "dowhile.end" | "function.end" | "procedure.end" | "openfile" | "readfile" | "writefile" | "closefile" | "seek" | "getrecord" | "putrecord" | "class.inherits" | "class.end" | "class_property" | "class_procedure.end" | "class_function.end">;
    name: Token;
    constructor(tokens: [Token, Token] | [Token, Token, Token, Token]);
